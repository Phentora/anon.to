...
<head>
    <meta charset="UTF-8">
    @if(!empty($allow_redirect))<meta http-equiv="refresh" content="1; url={{ $url }}" id="url">@endif
...
<div class="flex-center position-ref full-height">
    <div class="content">
        ...
        <div class="m-b-md"><a href="{{ $url }}" title="{{ $url }}" rel="noreferrer nofollow">{{ \Illuminate\Support\Str::limit($url,32) }}</a></div>
        <div><a href="{{ $url }}" title="{{ $url }}" rel="noreferrer nofollow" class="btn">continue &#129138;</a></div>
    </div>
</div>
