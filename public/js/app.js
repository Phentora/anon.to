...
var Form = /*#__PURE__*/function () {
  ...
  _createClass(Form, null, [{
    ...
    value: function Get(url) {
      return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(url)["catch"](function (thrown) {
    ...
    value: function Post(url, data) {
      return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, data).then(function (result) {
    ...
    value: function Delete(url) {
      sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.fire({
        ...
        if (result.value) {
          return axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"](url).then(function (result) {
            return Form._handleSuccess(result);
          })["catch"](function (thrown) {
            return Form._handleError(thrown);
          });
    ...
    key: "_handleSuccess",
    value: function _handleSuccess(result) {
...
document.querySelectorAll('[data-toggle="tooltip"]').forEach(function (element) {
  new _coreui_coreui__WEBPACK_IMPORTED_MODULE_0__["Tooltip"](element);
});
document.querySelectorAll('[data-toggle="popover"]').forEach(function (element) {
  new _coreui_coreui__WEBPACK_IMPORTED_MODULE_0__["Popover"](element);
});
document.querySelectorAll('[data-action]').forEach(function (element) {
  ...
  element.addEventListener('click', function (el) {
    if (action === 'get') {
      return new _Form__WEBPACK_IMPORTED_MODULE_1__["default"].Get(url);
    }

    if (action === 'post') {
      return new _Form__WEBPACK_IMPORTED_MODULE_1__["default"].Post(url, data);
    }

    if (action === 'delete') {
      return new _Form__WEBPACK_IMPORTED_MODULE_1__["default"].Delete(url);
    }
  });
});
var form = document.getElementById("form_shorten_url");

if (form) {
  form.addEventListener("submit", function (event) {
    event.preventDefault(); // Recaptcha
    ...
    var button = document.getElementById("btn_shorten");
    var output = document.getElementById("short_url_output");
    var spinner = document.createElement('i');
    spinner.classList.add('fa', 'fa-spinner', 'fa-spin', 'ml-2');
    output.classList.add('d-none');
    button.setAttribute('disabled', 'disabled');
    button.appendChild(spinner);
    _Form__WEBPACK_IMPORTED_MODULE_1__["default"].SubmitForm(form).then(function (result) {
      ...
      return _Form__WEBPACK_IMPORTED_MODULE_1__["default"]._handleError(thrown);
...
__webpack_require__(/*! D:\SITES\anon.to\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\SITES\anon.to\resources\sass\app.scss */"./resources/sass/app.scss");
